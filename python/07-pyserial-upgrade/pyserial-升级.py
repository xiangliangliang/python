...
save_time_path = 'D:/11-Python/06-api/'+filename+'.txt'

ser_port = get_COM_Port() # 获取串口

PC_TOOL_Upgrade() # 根据升级方式升级 1：app 2：full image 3：OTA

result = upgrade_result(ser_port) # 通过log查看升级是否成功


#get_version(ser_port) # 查看版本
